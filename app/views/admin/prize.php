...
<form class="prize" method="POST" action="/admin/prize">
    <section class="details">
        ...
        <ul class="help">
            <h5>Prize images should be:</h5>
            <li>saved in <strong>JPG</strong> format;</li>
            <li>a <strong>square</strong> image (1:1 aspect ratio);</li>
            <li>at least <strong>400 x 400</strong> pixels;</li>
            <li><strong>optimized</strong> with <a href="https://imageoptim.com/" target="_blank">ImageOptim</a>, <a href="https://kraken.io/" target="_blank">Karken.io</a>, or a similar image compression tool.</li>
        </ul>
    ...
    <section class="legal"><?=
        sprintf('<label for="award"><span>Awarded As ($100 gift card)</span><input type="text" name="award" value="%s"%s required/></label>', @$award, @$immutable ? ' disabled' : '').
        sprintf('<label for="value"><span>Retail Value (100)</span><input type="text" name="value" pattern="\d*" value="%s"%s required/></label>', @$value, @$immutable ? ' disabled' : '')

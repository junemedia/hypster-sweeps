<?php extract($data); $today_y_m_d = date('Y-m-d'); $today_timestamp = strtotime(date('Y-m-d')); $a_close = '</a>'; ?><? if (@$prizes): ?><div id="calendar"><?php if (@$disable_slideshow): $month = (@$prizes[0]['date']) ? date('F', strtotime($prizes[0]['date'])) : ''; ?><header><?= $month ?></header><?php endif; ?><div class="calendar<?= @$disable_slideshow ? '' : ' slideshow' ?>"><?php if (!@$disable_slideshow): ?><u class="fade left"></u><u class="fade right"></u><b class="prev"></b><b class="next"></b><div class="wrap"><?php endif; ?><?php foreach ($prizes as $c_prize):
